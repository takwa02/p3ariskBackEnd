...
/**
 * AIncdefaultId generated by hbm2java
 */
@Embeddable
public class AIncdefaultId implements java.io.Serializable {
	...
	public AIncdefaultId() {
	}

	public AIncdefaultId(String ctrMatfis) {
		this.ctrMatfis = ctrMatfis;
	}

	public AIncdefaultId(String ctrMatfis, BigDecimal critid, String actsec, String ctrCatego, BigDecimal tocat,
			BigDecimal defcnt) {
		this.ctrMatfis = ctrMatfis;
		this.critid = critid;
		this.actsec = actsec;
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof AIncdefaultId))
			return false;
		AIncdefaultId castOther = (AIncdefaultId) other;
