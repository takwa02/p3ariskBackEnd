...
/**
 * TempSelectScoresId generated by hbm2java
 */
@Embeddable
public class TempSelectScoresId implements java.io.Serializable {
	...
	public TempSelectScoresId() {
	}

	public TempSelectScoresId(Short taxYear, BigDecimal criteriaId, String ctrMatfis, BigDecimal score) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof TempSelectScoresId))
			return false;
		TempSelectScoresId castOther = (TempSelectScoresId) other;
