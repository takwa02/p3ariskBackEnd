...
/**
 * AVatdecdefId generated by hbm2java
 */
@Embeddable
public class AVatdecdefId implements java.io.Serializable {
	...
	public AVatdecdefId(String ctrMatfis) {
		this.ctrMatfis = ctrMatfis;
	}

	public AVatdecdefId(String ctrMatfis, BigDecimal critid, String actsec, String ctrCatego, BigDecimal tocat,
			BigDecimal defcnt) {
		this.ctrMatfis = ctrMatfis;
		this.critid = critid;
		this.actsec = actsec;
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof AVatdecdefId))
			return false;
		AVatdecdefId castOther = (AVatdecdefId) other;
